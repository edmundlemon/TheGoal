...
@section('content')
    <div class="hero" style="background-image: url('{{ asset('images/carimage/accbackgrd.jpg') }}');">
        <h1>About CAREN</h1>
    </div>

    <section class="intro">
        <h2 class="font-bold">Your Car, Everywhere</h2>
    ...
    <section class="purpose">
        <div class="purpose-item">
            <h3 class="font-bold">Business Purpose</h3>
            <p>Connecting travelers with mobility services through technology.</p>
        </div>
        <div class="purpose-item">
            <h3 class="font-bold">Vision And Mission</h3>
    ...
    <section class="leadership">
        ...
        <div class="leaders">
            <div class="leader-item">
                ...
                <h3 class="font-bold">Will Smith</h3>
                <p class="font-light">Founder & CEO</p>
            </div>
            <div class="leader-item">
                ...
                <p class="font-light">Chief Technology Officer</p>
            </div>
        </div>
    </section>
